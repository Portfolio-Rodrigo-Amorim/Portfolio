...
export const projects: Project[] = [
    ...
    // === 5 Olympicus ===
    {
        id: 20, title: 'Casa Summer Hunter — Olympicus', client: 'OLYMPICUS', category: 'BRAND ACTIVATION',
        description: 'Projeto de espaço imersivo para a ativação Casa Summer Hunter da Olympicus. A cenografia foca na identidade esportiva e dinâmica, com modelagem de estruturas leves, áreas de exposição de calçados e espaços de convivência ao ar livre. O render captura a vibração do verão e a modernidade dos materiais tecnológicos utilizados pela marca.',
    ...
    // === 10 MV Saúde - Convenção Unimed 2025 ===
    {
        id: 29, title: 'Convenção Unimed 2025 — MV Saúde', client: 'MV SAÚDE / UNIMED', category: 'CORPORATE EVENT',
    ...
    // === 10 MV Saúde - Fisweek ===
    {
        id: 30, title: 'Fisweek — MV Saúde', client: 'MV SAÚDE', category: 'EXHIBITION DESIGN',
